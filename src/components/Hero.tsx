...
type PopupStep = "loading" | "result" | "notify";
              ...
              <div className="flex items-stretch gap-3">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-white border-0 ring-1 ring-gray-200 focus:ring-2 focus:ring-[#0753BB] outline-none text-gray-700 text-base shadow-sm"
                  />
                </div>
                <button
              ...
              >
                ...
                <text className="text-[8px] font-bold uppercase tracking-widest fill-gray-400">
                  <textPath href="#circlePath">
                    Watch Our Company Video Now • Watch Our Company Video Now •
                  </textPath>
                </text>
              </svg>
              <div className="bg-gray-900 w-14 h-14 rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
                <div className="w-0 h-0 border-t-[8px] border-t-transparent border-l-[14px] border-l-[#0753BB] border-b-[8px] border-b-transparent ml-1"></div>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="px-6 py-5 space-y-4">
                  ...
                  <div className="rounded-lg bg-gray-50 p-4 space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900">MSC OSCAR</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">ETA</span>
                      <span className="text-sm font-medium text-gray-900">Mar 18, 2026</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">Port of Discharge</span>
                      <span className="text-sm font-medium text-gray-900">Durban, ZA</span>
                    </div>
                  </div>
                </div>
              ...
              <>
                <div className="px-6 py-5 space-y-3">
                  <p className="text-sm text-gray-500 mb-4">
                    Choose how you'd like to receive updates for <span className="font-medium text-gray-700">{inputValue}</span>:
                  </p>

                  {/* Email option */}
                  <button
                    onClick={() => toggleChannel("email")}
                    className={`w-full flex items-center gap-4 p-4 rounded-lg border-2 transition-colors cursor-pointer ${
                      selectedChannels.includes("email")
                        ? "border-[#0753BB] bg-blue-50/50"
                        : "border-gray-200 hover:border-gray-300"
                    }`}
                  >
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                      selectedChannels.includes("email") ? "bg-[#0753BB]" : "bg-gray-100"
                    }`}>
                      <svg className={`w-5 h-5 ${selectedChannels.includes("email") ? "text-white" : "text-gray-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div className="text-left">
                      <p className="text-sm font-semibold text-gray-900">Email</p>
                      <p className="text-xs text-gray-500">Receive detailed updates in your inbox</p>
                    </div>
                    {selectedChannels.includes("email") && (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                      selectedChannels.includes("whatsapp") ? "bg-[#25D366]" : "bg-gray-100"
                    }`}>
                      <svg className={`w-5 h-5 ${selectedChannels.includes("whatsapp") ? "text-white" : "text-gray-500"}`} fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Get instant alerts on your phone</p>
                    </div>
                    {selectedChannels.includes("whatsapp") && (
